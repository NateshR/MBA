...
public class StatusProvider extends ContentProvider {
	...
	static {
		...
		sURIMatcher.addURI(StatusContract.AUTHORITY,
				StatusContract.TABLE + "/#", StatusContract.STATUS_ITEM);
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case StatusContract.STATUS_DIR:
			break;
		case StatusContract.STATUS_ITEM:
			qb.appendWhere(StatusContract.Columns.ID + "="
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		long rowId = sqliteDatabase.insertWithOnConflict(StatusContract.TABLE,
				null, values, SQLiteDatabase.CONFLICT_IGNORE);

		if (rowId != -1) {
			long id = values.getAsLong(StatusContract.Columns.ID);
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case StatusContract.STATUS_ITEM:
			...
			where = StatusContract.Columns.ID
					+ " = "
					+ id
